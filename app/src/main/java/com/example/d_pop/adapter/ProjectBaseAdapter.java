...
public class ProjectBaseAdapter extends RecyclerView.Adapter<ProjectBaseAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ...
        viewHolder.projectItemLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, ProjectDetailsAndAlter.class);
    ...
    protected class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private LinearLayout projectItemLayout;
        public ViewHolder(@NonNull View itemView) {
            ...
            projectItemLayout = itemView.findViewById(R.id.project_item_recyclerview);
        }
    }
